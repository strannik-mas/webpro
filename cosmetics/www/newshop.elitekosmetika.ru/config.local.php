...
$config['db_name'] = 'newshop1';
$config['db_user'] = 'usernewshop';
$config['db_password'] = 'peSohr4y';
...
$config['http_host'] = 'newshop.elitekosmetika.ru';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'newshop.elitekosmetika.ru';
$config['https_path'] = '';
