...
<div class="row-fluid orders-wrap">
    <div class="span8">
        <div class="buttons-container">
                <div class="inline-block" id="button_trash_products">
                    {if $cart_products}
            ...
            {include file="pickers/products/picker.tpl" company_id=$order_company_id display="options_price" extra_var="order_management.add" data_id="om" no_container=true but_text="{__("advanced_products_search")}"}
        </div>
