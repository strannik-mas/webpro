...
<form action="{""|fn_url}" method="post" name="order_info_form" id="order_info_form" class="form-horizontal form-edit">
                            ...
                            <div class="clearfix">
                                {if $shipping.need_shipment}
                                    ...
                                    {if !"ULTIMATE:FREE"|fn_allowed_for}
                                        {if "shipments.add"|fn_check_view_permissions}
                                            {include file="common/popupbox.tpl" id="add_shipment_`$shipping.group_key`" content="" link_text="`$shipment_btn`<i class='icon icon-angle-right'></i>" act="link" link_class="pull-`$align`"}
                                        {/if}
                                    {else}
