        ...
        <form id="form" action="{""|fn_url}" method="post" name="product_update_form" class="form-horizontal form-edit  cm-disable-empty-files {if ""|fn_check_form_permissions || ($runtime.company_id && $product_data.shared_product == "Y" && $product_data.company_id != $runtime.company_id)} cm-hide-inputs{/if}" enctype="multipart/form-data"> {* product update form *}
            ...
            <div class="product-manage" id="content_detailed"> {* content detailed *}
                ...
                <div id="acc_information" class="collapse in">
                    ...
                    {if $product_type->isFieldAvailable("prices")}
                    ...
                    {if $product_type->isFieldAvailable("full_description")}
                ...
                {if $product_type->isFieldAvailable("options_type") || $product_type->isFieldAvailable("exceptions_type")}
                    ...
                    <div id="acc_options" class="collapse in">
                        {if $product_type->isFieldAvailable("options_type")}
                        ...
                        {/if}
                        {if $product_type->isFieldAvailable("exceptions_type")}
                            <div class="control-group {$promo_class}">
                ...
                <div id="acc_pricing_inventory" class="collapse in">
                    ...
                    {if $product_type->isFieldAvailable("product_code")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("list_price")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("amount")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("zero_price_action")}
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select class="span5" name="product_data[tracking]" id="elm_product_tracking" {if $settings.General.inventory_tracking == "N"}disabled="disabled"{/if}>
                                    {if $product_options || $product_data.product_type === "\Tygh\Addons\ProductVariations\Product\Manager::PRODUCT_TYPE_VARIATION"|constant}
                    ...
                    {if $product_type->isFieldAvailable("min_qty")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("max_qty")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("qty_step")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("list_qty_count")}
                        <div class="control-group">
                ...
                {if $product_type->isFieldAvailable("availability")}
                    <hr>
                    {include file="common/subheader.tpl" title=__("availability") target="#acc_availability"}
                    <div id="acc_availability" class="collapse in">
                        {if $product_type->isFieldAvailable("usergroup_ids") && !"ULTIMATE:FREE"|fn_allowed_for}
                            <div class="control-group">
                        ...
                        {if $product_type->isFieldAvailable("timestamp")}
                            <div class="control-group">
                ...
                {capture name="product_extra"}
                    {if $product_type->isFieldAvailable("details_layout")}
                        <div class="control-group">
                    ...
                    {if $settings.General.enable_edp == "Y" && $product_type->isFieldAvailable("edp")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("popularity")}
                        <div class="control-group">
                    ...
                    {if $product_type->isFieldAvailable("promo_text")}
                        <div class="control-group {$no_hide_input_if_shared_product}">
                ...
                {if $smarty.capture.product_extra|trim}
                    <hr>
            ...
            {if $product_type->isFieldAvailable("additional_images")}
            ...
            {if $product_type->isFieldAvailable("shippings")}
                ...
                {if $id}
                    {capture name="tools_list"}
                        {hook name="products:update_tools_list"}
                            ...
                            {/if}
                            {if $product_data.product_type === "\Tygh\Addons\ProductVariations\Product\Manager::PRODUCT_TYPE_SIMPLE"|constant}
