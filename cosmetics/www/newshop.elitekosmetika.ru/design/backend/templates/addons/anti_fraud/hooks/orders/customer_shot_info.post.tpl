...
<a class="cm-popover btn hand" data-toggle="popover" data-placement="bottom" data-content="{$smarty.capture.tools_list}" title="" data-original-title="{__("fraud_checking")}">{$smarty.capture.but_text}</a>
{/if}