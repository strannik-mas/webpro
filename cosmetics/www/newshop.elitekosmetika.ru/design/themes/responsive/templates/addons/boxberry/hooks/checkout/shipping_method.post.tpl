{if $cart.chosen_shipping.$group_key == $shipping.shipping_id && $shipping.module == 'boxberry'}
	...
	<div style="margin:10px 23px;">
        <label for="selected_point_id" class="cm-required">{__('boxberry.pickup_point')}:</label>
        ...
        >{$cart.shippings_extra.boxberry.$group_key.$shipping_id.pickup_data.address|default:__('boxberry.select_pickup_point')}</a>
	</div>
