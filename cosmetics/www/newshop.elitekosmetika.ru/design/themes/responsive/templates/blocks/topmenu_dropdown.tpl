...
<script type="text/javascript">
    ...
    $('.ty-menu__item-link').hover(function() {
        var th = $(this);
        $('.arrow').stop().animate(
            {
                left: $(th).position().left + (parseInt($(th).width()) / 2) + 4
            }, 500, 'swing', function() {
            }
        );
    });

    $('.delivery_tabs a:nth-child(2)').on('click', function() {
        $('.delivery_tabs a').removeClass('active');
    ...
    $('.delivery_tabs a:nth-child(1)').on('click', function() {
        $('.delivery_tabs a').removeClass('active');
        $(this).addClass('active');
        $('.deliv .tab2').hide();
        $('.deliv .tab1').show();
    ...
    $('.subcategories-left .ty-menu__submenu-item-header a').on('click', function() {
