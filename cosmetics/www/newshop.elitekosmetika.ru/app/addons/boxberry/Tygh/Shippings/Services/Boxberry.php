...
class Boxberry implements IService
{
    ...
    {
        if (isset($this->_shipping_info['service_params']['margin_percent']) && is_numeric($this->_shipping_info['service_params']['margin_percent'])) {
            $response['cost'] += ($response['cost'] * $this->_shipping_info['service_params']['margin_percent']) / 100;
        }
        if (isset($this->_shipping_info['service_params']['margin_plus']) && is_numeric($this->_shipping_info['service_params']['margin_plus'])) {
            $response['cost'] += $this->_shipping_info['service_params']['margin_plus'];
        }
    ...
    public function getSimpleRates()
    {
        ...
        if ($service_code == 'boxberry_courier' || $service_code == 'boxberry_courier_prepaid') {
            ...
            try {
                $pickups_list = $this->client->getPickupPoints($city);
