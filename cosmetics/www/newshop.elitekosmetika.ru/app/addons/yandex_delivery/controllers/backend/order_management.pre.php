        ...
        if (!empty($old_ship_data)) {
            ...
            foreach ($old_ship_data as $shipping) {
                ...
                if (fn_yandex_delivery_check_type_delivery($shipping['service_params'])) {
                    $cart['shippings_extra']['data'][$group_key][$shipping_id]['courier_point_id'] = $shipping['point_id'];
                } else {
                    $cart['shippings_extra']['data'][$group_key][$shipping_id]['pickup_point_id'] = $shipping['point_id'];
                }
            }
        }
    }
