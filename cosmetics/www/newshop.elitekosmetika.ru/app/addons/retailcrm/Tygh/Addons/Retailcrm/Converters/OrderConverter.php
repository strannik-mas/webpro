...
class OrderConverter
{
    ...
    public function convertToCrmOrder(array $order, $customer_id)
    {
        ...
        foreach ($order['products'] as $product) {
            $item = array(
                'initialPrice' => (float) $product['original_price'],
    ...
    public function convertToShopOrder(array $order)
    {
        ...
        $result = array(
            ...
            'firstname' => $order['firstName'],
            's_firstname' => $order['firstName'],
            'b_firstname' => $order['firstName'],
            'lastname' => $order['lastName'],
            's_lastname' => $order['lastName'],
            'b_lastname' => $order['lastName'],
        ...
        if (!empty($order['email'])) {
            $result['user_data']['email'] = $result['email'] = $order['email'];
        } elseif (!empty($order['customer']['email'])) {
            $result['user_data']['email'] = $result['email'] = $order['email'];
        } else {
            $result['user_data']['email'] = $result['email'] = $order['id'] . '@example.com';
        }
        ...
        if (!empty($order['delivery'])) {
            $result['shipping_ids'] = $this->settings->getInternalShippingType($order['delivery']['code']);
