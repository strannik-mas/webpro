...
<?php if($file_style == "block") { ?>
    <div class="fileDiv" >
        ...
        <p class="fileDescription"></p>
        <p class="fileTime"></p>
        <p class="fileTime"></p>
    </div>
<?php } elseif($file_style == "list") { ?>
    <div class="fullWidthFileDiv">
        <div class="fullWidthimgDiv"><img class="fullWidthfileImg lazy" data-original=""></div>
        <p class="fullWidthfileDescription"></p>
        <p class="fullWidthfileTime fullWidthfileMime"></p>
        <p class="fullWidthfileTime"></p>
        <p class="fullWidthfileTime fullWidth30percent"></p>
    </div>
<?php } ?>
