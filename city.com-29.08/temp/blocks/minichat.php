		...
		<div class="dropdown-menu">
				...
				<div>
					<div class="create-message-inner">
						...
						<form onsubmit="return false;" method='post' id='add_privatemessage'>
							...
							<input type="hidden" name="to" value="<? echo $uuid; ?>" />
			...
			<div class="your-chat">
				<div class="chat-user-info">
					<div class="chat-user">
						<a href="index.php?ops=users2&type=page&uid=<? echo $uuid; ?>"><span class="img-inner"><img src="<? echo htmlspecialchars(phpThumbURL('src=../../' . avatar2_user($uuid) . '&w=68&h=68&zc=1', './common/phpthumb/phpThumb.php')); ?>" alt="user" class="img-circle img-responsive"></span></a>
					</div>
