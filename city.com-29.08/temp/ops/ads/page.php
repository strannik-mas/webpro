						...
						<div class="product-view-desc col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
							...
							<div class="complain">
								...
								<div class="text-center">
									<a href="index.php?ops=complain&cops=ads&type=page&uid=<?php echo $uid; ?>&uuid=<? echo $uuid; ?>" onclick=""> <i class="fa fa-exclamation-circle" aria-hidden="true"></i> <i class="link-text">Пожаловаться</i> </a>
								</div>
							</div>
							<div class="buttons-inner">
								...
								<div>
									<a class="login-button" onclick="$('#minichatform .dropdown-menu').toggle(); newrequest('getMiniChat','#scrollbarminichat','<? echo $uid; ?>'); newrequest('cookie','','chatto,<? echo $uid; ?>,3600'); newrequest('chatto_html','.chat-user-info','');">Написать продавцу</a>
								</div>
