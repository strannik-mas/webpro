						...
						<form method="POST" action="./common/ajax.php" id="edit_ad">
							...
							<div class="form-add">
								<div class="form-group caption">
									...
									<input name="name" placeholder="" required="" class="form-control" type="text" value="<?php echo elem_ad($uid, "name", "ads"); ?>">
								</div>
								...
								<div class="textarea-inner">
									...
									<div class="textarea">
										<textarea name="desc"><?php echo elem_ad($uid, "desc", "ads"); ?></textarea>
									</div>
							...
							<div class="form-add-choose">
								<div>
									<div class="form-group price-choose">
										<label>Цена</label>
										<input name="price" placeholder="" class="form-control" type="number'" value="<?php echo elem_ad($uid, "price", "ads"); ?>">
										<span>Руб</span>
									</div>
									<div class="check-big">
										<div class="check">
								...
								<div class="your-city">
									<span>Ваш город:</span><i class="fa fa-map-marker" aria-hidden="true"></i><input value="<?php echo elem_ad($uid, "city", "ads"); ?>" onfocus="initMap2();" type="address" placeholder="Адрес" name="adress" class="form-control" id="cities">
								</div>
								<div class="form-tel">
									<label>Телефон</label>
									<input name="phone" placeholder="" class="form-control" type="tel" value="<?php echo elem_ad($uid, "phone", "ads"); ?>">
									<a onclick="$('.form-tel2').toggle();" class="add-tel">+<span> Добавить еще телефон</span></a>
								</div>
								<div class="form-tel2">
									<label>Телефон 2</label>
									<input name="phone2" placeholder="" class="form-control" type="tel" value="<?php echo elem_ad($uid, "phone2", "ads"); ?>">
								</div>
