									...
									<div>
										...
										<div class="complain">
											<div class="text-center">
												<a href="index.php?ops=complain&cops=users2&type=page&uid=<?php echo $uid; ?>" onclick=""> <i class="fa fa-exclamation-circle" aria-hidden="true"></i> <i class="link-text">Пожаловаться</i> </a>
											</div>
										</div>
									</div>
