...
class UploadHandler {
    ...
    public function handleUpload($uploadDirectory, $name = null){
		...
		$cpath = $uploadDirectory[1];
		$ops = $uploadDirectory[2];
		$uploadDirectory = $uploadDirectory[0];
        ...
        # non-chunked upload
            ...
            if ($target){
                ...
                if (move_uploaded_file($file['tmp_name'], $target)){
					//Insert to DB with temp
					global $link;
					$link -> query("INSERT INTO images SET unit = '{$ops}', entid = '{$uuid}', entity = 'upload', path = 'uploads/{$uuid}', temp = '1', filename = '{$name}'");
					
					return array('success'=> true, "uuid" => $uuid, "thepath"=> $target, "error"=> mysqli_error($link));
                }
            }
