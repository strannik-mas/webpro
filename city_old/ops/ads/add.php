					...
					<div class="row">
						...
						<form method="POST" action="./common/ajax.php" id="add_ad">
							...
							<div class="form-add">
								...
								<div class="form-group selection-group">
									...
									<div class="nice-select" tabindex="0">
										<span class="current">Рубрика</span>
										<ul class="list">
											<li data-value="Рубрика" class="option selected focus">
												Рубрика
											</li>
											<?php
											$groups = $link -> query("SELECT * FROM ad_groups");
							...
							<div class="form-add-choose">
								...
								<div class="your-city">
									<span>Ваш город:</span><i class="fa fa-map-marker" aria-hidden="true"></i><input type="text" placeholder="Адрес" name="adress" class="form-control" id="streetaddr">
								</div>
								<div class="form-tel">
									<label>Телефон</label>
									<input name="phone" placeholder="" class="form-control" type="tel">
									<a href="#" class="add-tel">+<span> Добавить еще телефон</span></a>
								</div>
								<div class="form-tel2">
								...
								<div class="buttons-submit">
									<a href="#" class="more">Предпросмотр</a>
									<a href="#" class="more">Сохранить черновик</a>
									<a class="more" onclick="form_submit('#add_ad','.add_ad');">Опубликовать</a>
