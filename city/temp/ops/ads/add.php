					...
					<div class="row">
						...
						<form method="POST" action="./common/ajax.php" id="add_ad">
							...
							<div class="form-add-choose">
								...
								<div class="your-city">
									<span>Ваш город:</span><i class="fa fa-map-marker" aria-hidden="true"></i><input onfocus="initMap2();" type="address" placeholder="Адрес" name="adress" class="form-control" id="cities">
								</div>
								<div class="form-tel">
									<label>Телефон</label>
