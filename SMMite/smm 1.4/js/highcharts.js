...
(function(M, S) {
    ...
    (function(a) {
        ...
        a.defaultOptions = {
            ...
            lang: {
                loading: "Loading...",
                months: "???????°NˆN? ?¤?µ??Nˆ?°?»N? ???°NˆN‚ ????Nˆ?µ?»N? ???°?? ??NZ??N? ??NZ?»N? ??????N?N?N‚ ???µ??N‚N??±NˆN? ?z??N‚N??±NˆN? ????N??±NˆN? ?”?µ???°?±NˆN?".split(" "),
                shortMonths: "?????? ?¤?µ?? ???°NˆN‚ ????Nˆ ???°?? ??NZ?? ??NZ?» ?????? ???µ?? ?z??N‚ ????N? ?”?µ??".split(" "),
                weekdays: "?’??N???Nˆ?µN??µ??N??µ ?Y?????µ???µ?»N??????? ?’N‚??Nˆ?????? ??Nˆ?µ???° ?§?µN‚???µNˆ?? ?YN?N‚????N†?° ??N??±?±??N‚?°".split(" "),
                decimalPoint: ".",
    ...
    (function(a) {
        ...
        b(R.prototype, {
            ...
            orderSeries: function(a) {
                ...
                for (a = a || 0; a < b.length; a++) b[a] && (b[a].index = a, b[a].name = b[a].name)
            },
